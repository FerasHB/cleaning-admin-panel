// lib/recurrence.ts
// Hilfsfunktionen für wiederkehrende Aufträge (aus der Mobile-App portiert).
// Wochentage werden in der DB als stabile englische Kurzcodes ("mon" … "sun")
// gespeichert und nur in der UI auf Deutsch übersetzt.
